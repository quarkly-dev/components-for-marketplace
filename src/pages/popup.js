...
export default (() => {
	return <Theme theme={theme}>
		...
		<Box padding="0px 30px 50px 30px" quarkly-title="Wrapper" min-height="620px">
			...
			<Components.QuarklycommunityKitPopup>
				...
				<Box display="flex" padding="50px 50px 50px 50px">
					...
					<Box width="100%" padding="0px 0px 0px 20px">
						<Text font="--headline2">
							<Strong
						...
						<Text font="--base" text-align="left" color="--greyD2">
